...
def draw_window(red_ships, yellow_ships, red_bullets, yellow_bullets, red_missiles, yellow_missiles, WIN, SPACE, Y_SHIP_IMAGE, R_SHIP_IMAGE, DUST, FONT, spaceship_height, spaceship_width, explosion_group, global_state):
    ...
    WIN.blit(DUST, (-2000 - global_state.x % 2000, -2000 - global_state.y % 2000))
    ...
    for yellow in yellow_ships:
        Y_SHIP = pygame.transform.rotate(Y_SHIP_IMAGE, yellow.angle)
        if yellow.health > 0:
    ...
    for red in red_ships:
        R_SHIP = pygame.transform.rotate(R_SHIP_IMAGE, red.angle)
        if red.health > 0:
