...
def draw_window(red_ships, yellow_ships, red_bullets, yellow_bullets, red_missiles, yellow_missiles, WIN, SPACE, DUST, FONT, spaceship_height, spaceship_width, explosion_group, global_state):
