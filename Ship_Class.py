...
class Ship(pygame.Rect):
    def __init__(self, control_module, x, y, velocity, angular_velocity, acceleration, angle, height, width, bullet_type, missile_type, is_player=False):
    ...
    def scoot(self, width, height, bullet_list, missile_list, target_list, global_state):
