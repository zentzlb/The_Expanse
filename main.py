...
def main():
    ...
    if PCS == 'y':
        yellow = Ship(player_control, rnd.randint(0, 200), rnd.randint(0, 1000), 0, 'yellow', 'Sprinter', 'PA', 'swarm missile', is_player=True)
    ...
    while run:  # main loop
        ...
        """Render Window"""
        # t1 = time.time()
        draw_window(WIN, HUD, SPACE, DUST, explosion_group, MyGS, fps, HEIGHT, WIDTH)
        # t2 = time.time()
        # print(t2 - t1)
